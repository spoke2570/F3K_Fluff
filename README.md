...
To use this widget, download and expand the F3KFluff.zip file in the releases section of this repository and place the resulting folder "F3KFluff" in your radio's "Scripts" folder. Use the configure screens menue to get a full screen or full window widget screen. Use the configure widget menu to select the "F3K Fluff MB" from the list of available widgets, and configure the widget.      
